...
public class ReferralSourceGoalsUpdater extends DatabaseGoalsUpdaterAbs {
    ...
    public ReferralSourceGoalsUpdater(SourceManager sourceManager, Fetcher fetcher, JsonParser parser) {
