...
import models.views.ViewsByReferralSource;
...
public class ReferralSourceViewsUpdater extends DatabaseViewsUpdaterAbs {
    ...
    public ReferralSourceViewsUpdater(SourceManager sourceManager, Fetcher fetcher, JsonParser parser) {
        super(ViewsByReferralSource.class, dimensions, fetcher, parser);
