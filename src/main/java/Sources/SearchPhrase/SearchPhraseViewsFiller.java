...
public class SearchPhraseViewsFiller extends DatabaseViewsFiller {

    private SourceManager sourceManager;
    private static String dimensions = "ym:s:lastsignSearchPhrase";
    private SearchPhraseConstants CONSTANTS = new SearchPhraseConstants();

    private static Map<String, String> queriesMap = new HashMap<>();

    public SearchPhraseViewsFiller(SourceManager sourceManager, LocalDate endDate, Fetcher fetcher, JsonParser parser) {
