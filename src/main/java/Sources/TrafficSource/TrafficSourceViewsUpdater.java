...
public class TrafficSourceViewsUpdater extends DatabaseViewsUpdaterAbs {
    ...
    public TrafficSourceViewsUpdater(SourceManager sourceManager, Fetcher fetcher, JsonParser parser) {
        super(ViewsByTrafficSource.class, dimensions, fetcher, parser);
    ...
    private String createEmptyInsertQuery(Long webpageId) {
        String values =  "(nextval('hibernate_sequence'), " + webpageId + ", '" + yesterday  + "', 'organic', 0)";
